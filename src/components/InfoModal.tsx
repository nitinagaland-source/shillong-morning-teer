      ...
      <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl border border-[#48c9c0] overflow-hidden flex flex-col max-h-[85vh]">
        ...
        <div className="flex items-center justify-between px-6 py-4 bg-linear-to-r from-[#48c9c0] to-[#48c9c0] border-b border-[#48c9c0]">
          <div className="flex items-center gap-2.5">
            {type === 'about' && <Info className="w-5 h-5 text-[#111827]" />}
            {type === 'terms' && <FileText className="w-5 h-5 text-[#111827]" />}
            {type === 'privacy' && <ShieldCheck className="w-5 h-5 text-[#111827]" />}
            {type === 'contact' && <Mail className="w-5 h-5 text-[#111827]" />}
          ...
          <button
            onClick={onClose}
            className="p-1.5 text-slate-400 hover:text-[#111827] hover:bg-white rounded-full transition-colors cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-6 overflow-y-auto space-y-4 text-slate-700 text-sm leading-relaxed">
          {type === 'about' && (
            <div className="space-y-3">
              ...
              <h4 className="font-bold text-[#111827] text-base pt-2">Our Mission</h4>
              <p>
              ...
              <h4 className="font-bold text-[#111827] text-base pt-2">Heritage &amp; Culture</h4>
              <p>
          ...
          {type === 'terms' && (
            <div className="space-y-3">
              ...
              <h4 className="font-bold text-[#111827] text-base pt-2">Informational Purposes Only</h4>
              <p>
              ...
              <h4 className="font-bold text-[#111827] text-base pt-2">No Financial Guarantees</h4>
              <p>
              ...
              <h4 className="font-bold text-[#111827] text-base pt-2">Legal Age &amp; Jurisdiction</h4>
              <p>
          ...
          {type === 'privacy' && (
            <div className="space-y-3">
              ...
              <h4 className="font-bold text-[#111827] text-base pt-2">Information Collection</h4>
              <p>
              ...
              <h4 className="font-bold text-[#111827] text-base pt-2">Cookies &amp; Local Cache</h4>
              <p>
              ...
              <h4 className="font-bold text-[#111827] text-base pt-2">Data Security</h4>
              <p>
            ...
            <div>
              {formSent ? (
                <div className="py-8 flex flex-col items-center text-center space-y-3">
                  <div className="w-12 h-12 rounded-full bg-[#b8e8e3] flex items-center justify-center text-[#111827]">
                    <CheckCircle2 className="w-7 h-7" />
                  </div>
                  <h4 className="font-bold text-[#111827] text-base">Message Sent Successfully!</h4>
