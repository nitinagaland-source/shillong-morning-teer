...
export const InfoModal: React.FC<InfoModalProps> = ({ type, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-150">
      <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl border border-sky-100 overflow-hidden flex flex-col max-h-[85vh]">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 bg-linear-to-r from-blue-50 to-indigo-50 border-b border-indigo-100">
          <div className="flex items-center gap-2.5">
            {type === 'about' && <Info className="w-5 h-5 text-indigo-600" />}
            {type === 'terms' && <FileText className="w-5 h-5 text-indigo-600" />}
            {type === 'privacy' && <ShieldCheck className="w-5 h-5 text-indigo-600" />}
            {type === 'contact' && <Mail className="w-5 h-5 text-indigo-600" />}
          ...
          <button
            onClick={onClose}
            className="p-1.5 text-slate-400 hover:text-indigo-700 hover:bg-white rounded-full transition-colors cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-6 overflow-y-auto space-y-4 text-slate-700 text-sm leading-relaxed">
          {type === 'about' && (
            <div className="space-y-3">
              ...
              <h4 className="font-bold text-indigo-950 text-base pt-2">Heritage &amp; Culture</h4>
              <p>
          ...
          {type === 'terms' && (
            <div className="space-y-3">
              ...
              <h4 className="font-bold text-indigo-950 text-base pt-2">No Financial Guarantees</h4>
              <p>
              ...
              <h4 className="font-bold text-indigo-950 text-base pt-2">Legal Age &amp; Jurisdiction</h4>
              <p>
          ...
          {type === 'privacy' && (
            <div className="space-y-3">
              ...
              <h4 className="font-bold text-indigo-950 text-base pt-2">Information Collection</h4>
              <p>
              ...
              <h4 className="font-bold text-indigo-950 text-base pt-2">Cookies &amp; Local Cache</h4>
              <p>
              ...
              <h4 className="font-bold text-indigo-950 text-base pt-2">Data Security</h4>
              <p>
                ...
                <form onSubmit={handleSubmitContact} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:outline-indigo-500"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:outline-indigo-500 resize-none"
                    />
                  </div>
                  <button
                    type="submit"
