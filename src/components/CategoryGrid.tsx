    ...
    <section id="categories-section" className="w-full">
      ...
      >
        ...
        <button
          ...
          className="order-1 group relative aspect-square rounded-2xl overflow-hidden shadow-md hover:shadow-xl hover:scale-[1.025] active:scale-[0.975] transition-all duration-200 cursor-pointer focus:outline-hidden p-0 border border-black/10"
          title="Common Number"
        >
        ...
        <button
          ...
          className="order-5 group relative aspect-square rounded-2xl overflow-hidden shadow-md hover:shadow-xl hover:scale-[1.025] active:scale-[0.975] transition-all duration-200 cursor-pointer focus:outline-hidden p-0 border border-orange-300"
          title="DEAL"
        >
          <svg viewBox="0 0 200 200" className="w-full h-full select-none" xmlns="http://www.w3.org/2000/svg">
            <defs>
        ...
        <button
          ...
          className="order-6 group relative aspect-square rounded-2xl overflow-hidden shadow-md hover:shadow-xl hover:scale-[1.025] active:scale-[0.975] transition-all duration-200 cursor-pointer focus:outline-hidden p-0 border border-black/10"
          title="Dream Number"
        >
          <svg viewBox="0 0 200 200" className="w-full h-full select-none" xmlns="http://www.w3.org/2000/svg">
            <defs>
        ...
        <button
          ...
          className="order-2 group relative aspect-square rounded-2xl overflow-hidden shadow-md hover:shadow-xl hover:scale-[1.025] active:scale-[0.975] transition-all duration-200 cursor-pointer focus:outline-hidden p-0 border border-blue-900/50"
          title="Analytics"
        >
          <svg viewBox="0 0 200 200" className="w-full h-full select-none" xmlns="http://www.w3.org/2000/svg">
            <defs>
        ...
        <button
          ...
          className="order-4 group relative aspect-square rounded-2xl overflow-hidden shadow-md hover:shadow-xl hover:scale-[1.025] active:scale-[0.975] transition-all duration-200 cursor-pointer focus:outline-hidden p-0 border border-amber-900/40"
        ...
        <button
          ...
          className="order-3 group relative aspect-square rounded-2xl overflow-hidden shadow-md hover:shadow-xl hover:scale-[1.025] active:scale-[0.975] transition-all duration-200 cursor-pointer focus:outline-hidden p-0 border border-teal-700/40"
